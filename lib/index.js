  ...
  _createClass(SVGInline, [{
    ...
    value: function render() {
      var _props = this.props,
          ...
          componentProps = _objectWithoutProperties(_props, ["className", "component", "svg", "fill", "stroke", "width", "accessibilityLabel", "accessibilityDesc", "classSuffix", "cleanupExceptions"]);
      ...
      var svgStr = SVGInline.cleanupSvg(svg, cleanup).replace(/<svg/, "<svg class=\"" + svgClasses + "\"" + (fill ? " fill=\"" + fill + "\"" : "") + (stroke ? " stroke=\"" + stroke + "\"" : "") + (width || height ? " style=\"" + (width ? "width: " + width + ";" : "") + (height ? "height: " + height + ";" : "") + "\"" : ""));
      var match = void 0;
